...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/mahambasharat/PycharmProjects/PythonRevise/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/mahambasharat/PycharmProjects/PythonRevise/venv/bin/deactivate.nu'
